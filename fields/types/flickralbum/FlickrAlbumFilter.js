...
class FlickrAlbumFilter extends Component {
	constructor () {
		super();
	...
	handleClick (option, selected) {
		selected ? this.removeOption(option) : this.flickralbumOption(option);
	}
	updateFilter (value) {
...
FlickrAlbumFilter.getDefaultValue = getDefaultValue;
FlickrAlbumFilter.defaultProps = {
	filter: getDefaultValue(),
};

module.exports = FlickrAlbumFilter;
